        ...
        <Box display="flex" alignItems="center" justifyContent="center" flexDirection="column" h="100vh" w="100%">
          ...
          <FormControl maxW="24rem">
            ...
            <Box mb={4}>
              ...
              <Input type="password" placeholder="Choose a super powerful password" />
            </Box>
            ...
            <Button w="100%" colorScheme="green">Create account</Button>

            <Text mt={8}>Already have an account? <NextLink href="/login"><Link style={{ color: "green" }}>Log in then.</Link></NextLink></Text>
          </FormControl>
        </Box>
      </>
  )
